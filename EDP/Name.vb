...
Public Class Name
    ...
    Private Sub PrintPageHandler(ByVal sender As Object, ByVal e As Printing.PrintPageEventArgs)
        Dim connString As String = "Server=localhost;Database=dog_database;Uid=root;Pwd=shemitsme123;"
        Dim conn As MySqlConnection = New MySqlConnection(connString)
        Dim cmd As MySqlCommand = New MySqlCommand("SELECT dogname_id, nickname
            FROM dog_name", conn)
